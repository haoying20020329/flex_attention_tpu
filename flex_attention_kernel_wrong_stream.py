...
def make_flash_attention_kernel(mask_fn=None, block_mask_fn=None, score_jaxpr=None):
  ...
  def flash_attention_fwd_kernel(
    ...
    # initialization at first kv tile
    ...
    # ============================================================
    # Step 8: Compute Score (similarity) between queries and keys
    # ============================================================        
        ...
        # customized mask function (casual included)
        # mask out future KV positions relative to the current query by setting their scores to -∞.
    ...
    # ============================================================
    # Step 9: Compute intermediate m and l
    # ============================================================
    ...
    # ============================================================
    # Step 10: Compute Partial Output for current query
    # ============================================================
    ...
    # ===============================================================
    # Step 10: Oputput for one query tile complete, write it to HBM
    # ===============================================================
